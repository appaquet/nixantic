...
let
  ...
  autodiscoveredOwnerSources = sourcesLib.discoverSources ./fixtures/autodiscovery;
  ...
  conflictingOwnerResult = builtins.tryEval (
    (builders.normalizeSourceDeclarations (sourcesLib.discoverSources ./fixtures/discovery-conflict))
    .sources.blocks
  );
  ...
  cases = [
    ...
    # Auto-discovery
    {
      name = "source-set auto-discovery sorts directories deterministically";
      pass =
    ...
    {
      name = "source-set auto-discovery loads new directories without registry edits";
      pass =
    ...
    {
      name = "source-set auto-discovery preserves skill subfiles";
      pass =
    ...
    {
      name = "source-set auto-discovery duplicate keys fail with provenance";
